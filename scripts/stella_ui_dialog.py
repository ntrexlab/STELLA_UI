...
class MyFrame(rtmgr.MyFrame):
	...
	def __init__(self, *args, **kwds):
		...
		self.t_robot.start()
		rospy.Subscriber('tf', tfMessage, self.robot_status_data_position)
...
#		return (enable, msg)
	...
	def robot_status_data_position(self,data):
		if data.transforms[0].header.frame_id == "map":
			self.robot_cur_x = data.transforms[0].transform.translation.x
			self.robot_cur_y = data.transforms[0].transform.translation.y
